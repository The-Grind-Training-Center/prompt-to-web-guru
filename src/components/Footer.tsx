        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-6">
              ...
              <a href="https://www.facebook.com/thegrindokc" target="_blank" rel="noopener noreferrer" className="bg-secondary-foreground/10 hover:bg-primary p-3 rounded-full transition-colors">
